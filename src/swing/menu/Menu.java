...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new ModelMenu("deposit", "Deposit", ModelMenu.MenuType.MENU));
        listMenu1.addItem(new ModelMenu("withdraw", "Withdraw", ModelMenu.MenuType.MENU));
        listMenu1.addItem(new ModelMenu("transfer", "Transfer", ModelMenu.MenuType.MENU));
        listMenu1.addItem(new ModelMenu("bills", "Bills", ModelMenu.MenuType.MENU));
        listMenu1.addItem(new ModelMenu("", "", ModelMenu.MenuType.EMPTY));
        listMenu1.addItem(new ModelMenu("", "", ModelMenu.MenuType.EMPTY));
        listMenu1.addItem(new ModelMenu("", "", ModelMenu.MenuType.EMPTY));
        listMenu1.addItem(new ModelMenu("", "", ModelMenu.MenuType.EMPTY));
        listMenu1.addItem(new ModelMenu("", "", ModelMenu.MenuType.EMPTY));
        listMenu1.addItem(new ModelMenu("settings", "Settings", ModelMenu.MenuType.MENU));
